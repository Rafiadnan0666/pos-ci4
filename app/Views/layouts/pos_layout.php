    ...
    <header style="background:#000;color:#fff;border-bottom:4px solid #FFDE4D;">
        <div class="max-w-full mx-auto" style="padding:.75rem 1rem;display:flex;align-items:center;justify-content:space-between;">
            ...
            <div style="display:flex;align-items:center;gap:.5rem;">
                <a href="<?= base_url('admin/dashboard') ?>" style="font-family:'Space Grotesk',Inter,sans-serif;font-weight:700;text-transform:uppercase;font-size:.75rem;padding:.5rem 1rem;border:4px solid #000;box-shadow:4px 4px 0px 0px rgba(0,0,0,1);cursor:pointer;background:#06B6D4;color:#fff;text-decoration:none;display:inline-flex;align-items:center;gap:.5rem;"
                   onmouseover="this.style.boxShadow='2px 2px 0px 0px #000';this.style.translate='2px 2px'"
                   onmouseout="this.style.boxShadow='4px 4px 0px 0px rgba(0,0,0,1)';this.style.translate='0'">📊 Admin</a>
                <span style="font-size:.875rem;color:#9CA3AF;" id="clock"></span>
                <a href="<?= base_url('pos/logout') ?>" style="font-family:'Space Grotesk',Inter,sans-serif;font-weight:700;text-transform:uppercase;font-size:.75rem;padding:.5rem 1rem;border:4px solid #000;box-shadow:4px 4px 0px 0px rgba(0,0,0,1);cursor:pointer;background:#EF4444;color:#fff;text-decoration:none;display:inline-flex;align-items:center;gap:.5rem;"
                   onmouseover="this.style.boxShadow='2px 2px 0px 0px #000';this.style.translate='2px 2px'"
                   onmouseout="this.style.boxShadow='4px 4px 0px 0px rgba(0,0,0,1)';this.style.translate='0'">Logout</a>
            </div>
        </div>
    </header>
